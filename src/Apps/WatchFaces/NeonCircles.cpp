...
NeonCircles::NeonCircles() {
	int32_t width = RESOLUTION_WIDTH / 4;
...
void NeonCircles::render() {
	...
	TTGOClass::getWatch()->tft->fillCircle(RESOLUTION_WIDTH / 2, 68, 5, ((currentTime.second % 2) == 0) ? COLOR_MAIN_2 : COLOR_MAIN_1);
	TTGOClass::getWatch()->tft->fillCircle(RESOLUTION_WIDTH / 2, 88, 5, ((currentTime.second % 2) == 0) ? COLOR_MAIN_1 : COLOR_MAIN_2);
}
